...
A lot of these models relate the stress behavior to the strain rate ε ̇ and the Temperature. A popular way to describe this is given by the Zener-Hollomon parameter Z \cite{ZEN44}:
